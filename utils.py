...
def get_s_baselines_total_loss_s_for_ACLNK_RNN(loader, model, save_filename=None, params_path=None):
    all_loss_s = []
...
def get_s_baselines_total_loss_s_for_ACLNK_DEMO_DOWN(loader, model, downstream='NPR', save_filename=None, params_path=None):
    all_loss_s = []
...
# for downstream validation bencnmark
def get_s_baselines_total_loss_s_for_ACLNK_DOWN(loader, model, downstream='NPR', save_filename=None, params_path=None):
    all_loss_s = []
    all_ground_truth_users = []
    all_predicted_topK = []
    for input in loader:
