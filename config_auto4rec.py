...
class get_param(object):
    ...
    def __init__(self, args):
        ...
        self.dataset_pick = args.dataset_pick
        ...
        # training_steps_tune = 15000  # steps on Rec task twowar
        if args.cross == "True" or "twowar" in self.dataset:
        ...
        self.dis_dim = self.d_model
        # self.n_gpus = args.n_gpu


        self.training_steps_tune = 645 # NYC:649;JKT:645,360,360,110;gow_调整参数后:857

####new_jkt_lp_dmodel2048:226